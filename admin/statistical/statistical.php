...
<div class="grid-statistical">
    ...
    <div class="grid-statistical-item">
        ...
        if ($totalToday > 0) {
        ?>
        <div class="price"><?=$totalToday?><sup>đ</sup></div>
        <?php } else { ?>
    ...
    <div class="grid-statistical-item">
        ...
        if ($totalYesterday > 0) {
        ?>
        <div class="price"><?=$totalYesterday?><sup>đ</sup></div>
        <?php } else { ?>
    ...
    <div class="grid-statistical-item">
        ...
        <div class="price"><?=$totalAmount?><sup>đ</sup></div>
        <?php }else { ?>
    ...
    <div class="grid-statistical-item">
        ...
        if ($totalAmount_2 > 0) {
        ?>
        <div class="price"><?=$totalAmount_2?><sup>đ</sup></div>
        <?php }else { ?>
          <div class="price">Không có dữ liệu cho tháng này!</div>
        <?php } ?>
    </div>
    ...
    <div class="grid-statistical-item">
        ...
        <div class="price"><?=$total?><sup>đ</sup></div>
    </div>
</div>
<div class="statistical-order">
  <div class="statiscal-order-item">
    ...
    <div class="quantity-order">
      ...
      ?>
      <strong style="font-size:1.2rem;"><?=$totalOrder['total_order']?></strong>
    </div>
  </div>
  <div class="statiscal-order-item">
    ...
    <div class="quantity-order">
      ...
      ?>
      <strong style="font-size:1.2rem;"><?=$orderPending['total_order']?></strong>
    </div>
  </div>
  <div class="statiscal-order-item">
    ...
    <div class="quantity-order">
      ...
      ?>
      <strong style="font-size:1.2rem;"><?=$order_transport['total_order']?></strong>
    </div>
  </div>
  <div class="statiscal-order-item">
    ...
    <div class="quantity-order">
      ...
      ?>
      <strong style="font-size:1.2rem;"><?=$orders_delivered['total_order']?></strong>
    </div>
  </div>
</div>
